...
# Фикстура (основная) для проверки генераторов (feature 11_1)
@pytest.fixture
...
# Фикстура (без "currency" и "description") для проверки генераторов (feature 11_1)
@pytest.fixture
def transactions_missing_currency_and_description() -> list:
    return [
        {
            "id": 939719570,
            "state": "EXECUTED",
...
# Фикстура (ожидаемые description) для проверки генераторов (feature 11_1)
@pytest.fixture
...
# Фикстура для проверки генератора card_number_generator (feature 11_1)
@pytest.fixture
def expected_card_number():
